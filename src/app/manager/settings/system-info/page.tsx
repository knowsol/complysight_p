...
const MgrSysInfo = () => {
  ...
  return <div>
    <PageHeader title="시스템정보" breadcrumb="홈 > 환경설정 > 시스템정보" />
    <DataTable sectionTitle="시스템 속성 정보" sectionCount={filtered.length} cols={[
      { title: "KEY", fieldKey: "k", align: "left" },
      { title: "VALUE", fieldKey: "v", align: "left" },
